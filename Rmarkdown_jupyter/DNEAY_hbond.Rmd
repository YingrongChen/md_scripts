...
```{r}
setwd('/dors/meilerlab/home/chey120/chainA_chainA/Data')
...
write.table(out_forw, file = "/dors/meilerlab/home/chey120/chainA_chainA/Data/DNEAY_forw.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
write.table(out_rev, file = "/dors/meilerlab/home/chey120/chainA_chainA/Data/DNEAY_rev.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
```