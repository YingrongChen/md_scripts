...
# tica.save('tica.pyemma', model_name='tica', overwrite=True)
...
# msm = pyemma.msm.estimate_markov_model(cluster.dtrajs, lag=1, dt_traj='10 ps')
msm = pyemma.load('msm.pyemma', model_name='msm')
