...
trajfile=glob.glob("KEGVL_1bx2_trial?_prod.combine.nc")
print(trajfile)
...
msm = pyemma.msm.bayesian_hidden_markov_model(cluster.dtrajs, nstates, lag=nlag, stride=nstride, dt_traj='10 ps')
msm.save(prefix+'hmm.pyemma', model_name='hmm', overwrite=True)
...
pyemma.coordinates.save_trajs(
    reader,
    pcca_samples,
    outfiles = ['./data/{}{}hmmsamples.pdb'.format(prefix, n + 1) for n in range(msm.n_metastable)])
